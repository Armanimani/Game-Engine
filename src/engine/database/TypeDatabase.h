...
#include <string>
#include "../camera/CameraProjectionType.h"
...
public:
	...
	static CameraProjectionType getCameraProjectionType(const std::string& value);
	...
	static const std::string getCameraProjectionTypeName(const CameraProjectionType& value);
