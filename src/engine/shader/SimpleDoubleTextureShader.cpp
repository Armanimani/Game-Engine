#include "SimpleDoubleTextureShader.h"

void SimpleDoubleTextureShader::render(const std::shared_ptr<Entity> entity)
{
	start();
	...
	glBindTexture(GL_TEXTURE_2D, entity->getModel()->getMaterial()->getProperties().texture1->getID());
...
void SimpleDoubleTextureShader::loadAllToUniform(const std::shared_ptr<Entity> entity)
{
...
void SimpleDoubleTextureShader::getAllUniformLocations()
{
	std::string temp;
...
void SimpleDoubleTextureShader::prepareTextures()
{
	std::string temp = "matDiffuseTexture1";
